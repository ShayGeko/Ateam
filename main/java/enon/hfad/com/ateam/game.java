...
public class game extends AppCompatActivity {
    ...
    public void animation(View dwarf, long speed, long field){
        TranslateAnimation dwarf_horizontal = new TranslateAnimation(0,field,40,40);
        dwarf_horizontal.setDuration(field / speed * 1000);//field/speed*1000);
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void run() {
                if(dropped_dwarfs < free_dwarfs) {
                    ...
                    sec_view.setText(Integer.toString(m_seconds));
                     ...
                     else  if(pos <= 0){true_speed= speed;}//ограничение выхода за поле(влево)
        ...
        game_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((dropped_dwarfs<10)){ //&& (now_time/1000>time)){

                    dropped_dwarfs++;

                    dwarf.setImageResource(R.drawable.dwarf_dead);
                    TranslateAnimation dwarf_vertical = new TranslateAnimation(pos,pos+speed,40,height/2);
