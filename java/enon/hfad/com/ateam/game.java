...
public class game extends AppCompatActivity {
    ...
    public void play_clicked(View view) {
        ...
        plane.animate().xBy(width - 200 - pause_coordinates[0]).yBy(height / 4  - pause_coordinates[1]).setDuration(5000-((level-1)*250) - pause_time/1000);
    }
                                               ...
                                               if ((dropped_dwarfs < free_dwarfs)) {
                                                   ...
                                                   if (!game_was_started) {
                                                       ...
                                                       if ((current_time > wait_time || dropped_dwarfs == 0) && !game_was_paused) {
                                                           ...
                                                           TranslateAnimation dwarf_vertical = new TranslateAnimation(location[0], location[0], location[1], (int) (height * 0.7));
